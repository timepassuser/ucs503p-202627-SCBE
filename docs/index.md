...
After teachers complete the evaluation of answer sheets, the evaluated scripts can be scanned by a dedicated assistant and uploaded to SCBE. The platform will organize and manage the scanned documents and make each student's answer sheet available to them remotely.

Students will be able to view their evaluated answer sheets, verify their question-wise marks, and identify potential issues such as unchecked questions or incorrect totals. If a student finds a potential discrepancy, they can submit a review request through the platform for the teacher to examine.
...
One of the primary concerns identified was the additional effort required to scan and manage a large number of answer sheets. To address this, the proposed workflow assigns the scanning process to a dedicated assistant, while SCBE handles the subsequent organization and management of the scanned documents.
...
|---|---|---|
| Gurneet Singh | 1024170014 | Team Leader |
| Arpit Goyal | 1024170021 | Team Member |
| Alla Harshith | 1024170007 | Team Member |
